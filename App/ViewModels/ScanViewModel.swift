...
final class ScanViewModel: ObservableObject {
    ...
    init() {
        // Upload-Fortschritt aus dem Service spiegeln
    ...
    /// Aktualisiert meshAnchorCount aus dem Service (wird vom Timer aufgerufen).
    private func refreshMeshCount() {
